...
import { formatTitle, getCategoryName, getCategorySeoDesc, getLangCode } from "@/utils/utils";
import { useQuery } from "@apollo/client";
import { categoryDetailQuery, categoryDetailQueryVariables } from "@/queries/types/categoryDetailQuery";
...
const CategoryDetailPage: React.FC = () => {
  ...
  const {
    ...
    error,
    data,
  } = useQuery<categoryDetailQuery, categoryDetailQueryVariables>(CATEGORY_DETAIL_PAGE_QUERY, {
    variables: {
