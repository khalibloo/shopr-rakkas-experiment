...
import { formatTitle, getCollectionName, getCollectionSeoDesc, getLangCode } from "@/utils/utils";
import { useQuery } from "@apollo/client";
import { collectionDetailQuery, collectionDetailQueryVariables } from "@/queries/types/collectionDetailQuery";
...
const CollectionDetailPage: React.FC = () => {
  ...
  const {
    ...
    error,
    data,
  } = useQuery<collectionDetailQuery, collectionDetailQueryVariables>(COLLECTION_DETAIL_PAGE_QUERY, {
    variables: {
