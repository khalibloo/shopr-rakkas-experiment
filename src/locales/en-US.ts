...
export default {
  ...
  "cart.voucherCode.inapplicable": "Cart has not met minimum requirements for this voucher",
  ...
  "profile.changeEmail.newEmail.match": "New email is the same as current email",
  ...
  "settings.changePwd.newPwd.match": "New password should be different from old password",
  ...
  "settings.confirmation": "Are you sure you want to permanently shutdown your account?",
  ...
  "who.signup.success.confirm.desc": "We've sent you an email. Please click the link in the email to proceed.",
  ...
  "who.reqResetPwd.success.desc": "If email is registered on this site, you should receive reset instructions shortly.",
  ...
  "account.deactivate.request.success.desc": "We've sent you an email containing further instructions",
