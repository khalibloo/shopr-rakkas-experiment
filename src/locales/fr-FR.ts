...
export default {
  ...
  "form.invalid": "Veuillez vérifier le formulaire pour les erreurs et réessayer",
  "form.address.phone": "Numéro de Téléphone",
  "form.address.phone.required": "Veuillez saisir un numéro de téléphone",
  "form.address.phone.invalid": "S'il vous plaît entrer un numéro de téléphone valide",
  ...
  "cart.billingAddress.fail": "Échec de la définition de l'adresse de facturation",
  ...
  "cart.voucherCode.inapplicable": "Le panier n'a pas satisfait aux exigences minimales pour ce bon",
  ...
  "profile.changeEmail.newEmail.match": "Le nouvel e-mail est identique à l'e-mail actuel",
  ...
  "settings.changePwd.newPwd.match": "Le nouveau mot de passe doit être différent de l'ancien",
  ...
  "settings.confirmation": "Êtes-vous sûr de vouloir fermer définitivement votre compte?",
  ...
  "who.signup.agree.required": "Vous devez accepter nos conditions pour utiliser notre service",
  ...
  "who.resetPwd.success.desc": "Vous pouvez maintenant vous connecter avec votre nouveau mot de passe.",
  ...
  "account.confirm.invalidUrl.desc": "Veuillez utiliser le lien envoyé à votre email.",
  ...
  "account.deactivate.challenge.match": "Veuillez saisir la phrase de confirmation",
  "account.deactivate.request.success": "Demande de Désactivation de Compte Envoyée",
  ...
  // reset pwd
  "account.emailchange.title": formatTitle("Modifier la Confirmation de l'Email"),
